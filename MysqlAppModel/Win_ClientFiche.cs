    ...
    public partial class Win_ClientFiche : Form
    {
        ...
        private void Btn_OK_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                myclient.datecontact = Convert.ToDateTime(Txt_DateContact.Text);
        ...
        public void LoadData()
        {
            ...
            Txt_DateContact.Text = myclient.datecontact.ToString("dd/MM/yyyy");
        ...
        private void Txt_DateContact_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void Txt_DateContact_Validating(object sender, EventArgs e)
        {
            ChampDate monCode = new ChampDate();
            monCode.ScanCible = (MaskedTextBox)sender;
